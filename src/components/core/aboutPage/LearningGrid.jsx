...
const LearningGridArray = [
  ...
  },
  {
    ...
    description:
      "leading universities and companies to bring flexible, affordable, job-relevant online learning to individuals and organization...",
  },
  {
    order: 5,
        ...
        <div className="grid mx-auto w-[350px] xl:w-fit grid-cols-1 xl:grid-cols-4 mb-12">
            {
                LearningGridArray.map((card, index) => {
                    return(
                        ...
                        ${
                            card.order%2 === 1 ? "bg-richblack-700 h-[294px]" : "ring-richblack-800 h-[294px]"    
                         }
                         ${
