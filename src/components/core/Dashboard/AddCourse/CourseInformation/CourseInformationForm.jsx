...
export default function CourseInformationForm(){
  ...
  // tostring() used cuz multiple value exists
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-8 rounded-md border-[1px] border-richblack-700 bg-richblack-800 p-6" >
      ...
      <div className="flex flex-col space-y-2">
        ...
        <select  {...register("courseCategory",
          { required: true })} 
          defaultValue="" 
          id="courseCategory" 
        ...
        {errors.courseCategory && (<span className="ml-2 text-xs tracking-wide text-pink-200">  Course Category is Mandatory </span>)}
      </div>
      ...
      {/* Course Tags */}
      <ChipInput  label="Tags"  name="courseTags" placeholder="Enter Tags and press Enter to add more!!" register={register}  errors={errors} setValue={setValue} getValues={getValues} />
